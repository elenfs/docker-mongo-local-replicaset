...
mongod --port $PORT3 --dbpath /data/db3 --replSet $REPLICA_SET_NAME --bind_ip_all &
DB3_PID=$!
mongod --port $PORT2 --dbpath /data/db2 --replSet $REPLICA_SET_NAME --bind_ip_all &
DB2_PID=$!
mongod --port $PORT1 --dbpath /data/db1 --replSet $REPLICA_SET_NAME --bind_ip_all &
DB1_PID=$!
